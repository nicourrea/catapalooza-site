...
const HowToHelp = () => {
  return (
    <div className="text-gray-800 px-6 pt-24 pb-12 max-w-6xl mx-auto">
      <h1 className="text-4xl font-bold mb-8 text-center text-[#1D3557]">How You Can Help</h1>
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 text-center">
        ...
        <div className="bg-white shadow-md p-6 rounded-xl">
          ...
          <a
            ...
            className="mt-2 inline-block text-[#277DA1] font-semibold hover:underline"
          >
            View Available Cats
          </a>
        </div>
      ...
      <h2 className="text-2xl font-bold mt-16 mb-6 text-center text-[#1D3557]">Other Ways to Contribute</h2>
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 text-center">
        <div className="bg-white shadow-md p-6 rounded-xl">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#277DA1] hover:underline text-sm block mt-2"
          >
            Donate via PayPal
          </a>
        </div>
